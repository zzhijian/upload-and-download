...
function cancelQueue(instance) {
	if(undefined != instance.customSettings.cancelButtonId 
		&& null != instance.customSettings.cancelButtonId){
...
function fileDialogComplete(numFilesSelected, numFilesQueued) {
	try {
		if (this.getStats().files_queued > 0) {
			if(undefined != this.customSettings.cancelButtonId 
				&& null != this.customSettings.cancelButtonId){
